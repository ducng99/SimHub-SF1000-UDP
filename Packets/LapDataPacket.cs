    ...
    internal static class LapDataPacket
    {
        ...
        public static byte[] Read()
        {
            ...
            packet.m_lapData[0] = new LapData
            {
                ...
                m_safetyCarDelta = 0,
                m_carPosition = Utils.ClampByte(pluginManager.GetPropertyValue("DataCorePlugin.GameData.Position")),
                m_currentLapNum = Utils.ClampByte(pluginManager.GetPropertyValue("DataCorePlugin.GameData.CurrentLap")),
                m_pitStatus = pitStatus,
                m_sector = Utils.ClampByte(pluginManager.GetPropertyValue("DataCorePlugin.GameData.CurrentSectorIndex")),
