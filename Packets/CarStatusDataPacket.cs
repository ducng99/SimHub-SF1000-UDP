    ...
    internal static class CarStatusDataPacket
    {
        ...
        public static byte[] Read()
        {
            ...
            packet.m_carStatusData[0] = new CarStatusData
            {
                ...
                m_maxRPM = Convert.ToUInt16(pluginManager.GetPropertyValue("DataCorePlugin.GameData.MaxRpm")),
                m_idleRPM = (ushort)(Convert.ToDouble(pluginManager.GetPropertyValue("DataCorePlugin.GameData.MaxRpm")) * 0.33),
